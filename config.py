...
parser.add_argument('--data.val', type=str, default='ilsvrc_2012', metavar='VALSETS', nargs='+',
...
parser.add_argument('--data.train_source', type=str, default='multisource', 
                    choices=['multisource', 'singlesource'], help='Whether to use multisource or singlesource.')
parser.add_argument('--data.imgsize', type=int, default=84, help="image size")

# model args
default_model_name = 'url'
...
parser.add_argument('--headmodel.name', type=str, default='attentionhead', help='A name for attention head.')
...
# train args
parser.add_argument('--train.is_training', type=bool, default=True, help='Whether train or test.')
parser.add_argument('--train.batch_size', type=int, default=16, metavar='BS',
                    help='number of images in a batch')
parser.add_argument('--train.max_iter', type=int, default=10000, metavar='NEPOCHS',
...
parser.add_argument('--train.lr_policy', type=str, default='exp_decay', metavar='LR_policy',
...
parser.add_argument('--train.eval_freq', type=int, default=500, metavar='EVAL_FREQ',
...
# path args
parser.add_argument('--model.dir', default='./url/', type=str, metavar='PATH',
                    help='path of single domain learning models')
parser.add_argument('--headmodel.dir', default='', type=str, metavar='PATH',
                    help='path of head models')
parser.add_argument('--out.dir', default='../eval_res/', type=str, metavar='PATH',
                    help='directory to output the result and checkpoints')
parser.add_argument('--source', default='', type=str, metavar='PATH',
                    help='path of pretrained model')

parser.add_argument('--experiment_name', type=str, default='exp1', help='Name of current experiment.')
parser.add_argument('--setting_name', type=str, default='train_on_all_datasets', help='Name of current experiment.')
parser.add_argument('--reset_mode', type=str, default='zeros', help="Mode of resetting attention head.")
parser.add_argument('--param_scale', type=float, default=1., help="Scale the parameters of the head layers.")
parser.add_argument('--out_dim', type=int, default=512, help="output dimension of attention & head")
parser.add_argument('--inner_iter', type=int, default=50, help="number of inner loop iterations during fine-tune training.")
parser.add_argument('--weight_decay', type=float, default=0.01, help="weight decay for optimizer.")
parser.add_argument('--regcoef', type=float, default=0.1, help="Coefficient of regularization.")
parser.add_argument('--scale_reconst', type=float, default=0.0001, help="Coefficient of regularization.")
parser.add_argument('--num_aug', type=int, default=1, help="number of augmented data sets.")
parser.add_argument('--gain', type=float, default=1e-4, help="Gain for initialization.")
